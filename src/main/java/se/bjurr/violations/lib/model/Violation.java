...
public class Violation implements Serializable {
 ...
 public String toString() {
  return "Violation [column=" + column + ", endLine=" + endLine + ", file=" + file + ", message=" + message
    + ", reporter=" + reporter + ", rule=" + rule + ", severity=" + severity + ", source=" + source + ", specifics="
    + specifics + ", startLine=" + startLine + "]";
 }
